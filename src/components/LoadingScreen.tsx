  ...
  return <AnimatePresence>
    {!isComplete && <motion.div initial={{
      ...
      <div className="flex flex-col items-center space-y-8">
        ...
        >
          <svg className="h-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 638 200" fill="none" stroke="currentColor" strokeWidth="14.8883">
            <motion.path
        ...
        <motion.div initial={{
          ...
          <p className="text-white/70 text-sm">Code. Intelligence. Innovation.</p>
        </motion.div>
      </div>
    </motion.div>}
  </AnimatePresence>;
