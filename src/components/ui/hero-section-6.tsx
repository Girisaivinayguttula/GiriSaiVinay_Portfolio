                ...
                <div className="relative mx-auto  px-6 py-28 lg:py-20">
                    <div className="lg:flex lg:items-center lg:gap-12">
                        <div className="relative z-10 mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left">
                            <a href="/" className="rounded-lg mx-auto flex w-fit items-center gap-2 border p-1 pr-3 lg:ml-0">
                                <span className="bg-muted rounded-[calc(var(--radius)-0.25rem)] px-2 py-1 text-xs">Available</span>
                            ...
                            <h1 className="mt-10 text-balance text-4xl font-bold md:text-5xl xl:text-5xl">Full Stack Developer & AI/ML Engineer</h1>
                            <p className="mt-8">Passionate about creating digital experiences that combine beautiful design with robust functionality. Specializing in modern web technologies and user-centered design.</p>
                            ...
                            <div className='py-8'>
                                ...
                                <div className="flex items-center gap-2 md:pr-1.5 lg:pr-0">
                                    ...
                                    <Button variant="outline" size="icon" className="rounded-full" asChild>
                                        <a href="gmailto:girisaivinayguttula@gmail.com">
                                    ...
                                    <Button variant="outline" size="icon" className="rounded-full" asChild>
                                        ...
                                        >
                                            <FileText className="h-4 w-4" /> {/* Add this line for the icon */}
                    ...
                    <div className="absolute inset-0 -mx-4 rounded-3xl p-3 lg:col-span-3">
                        ...
                        <div className="relative">
                            <video
                                src="/lovable-uploads/Play.mp4"
                                autoPlay
                                loop
                                muted
                                playsInline
                                className="w-full h-auto object-cover rounded-lg min-h-[300px] sm:min-h-[400px] lg:min-h-[500px]"
                                poster="/lovable-uploads/0e1e4b04-765b-47c9-a3a6-6de017b8e56e.png" // optional fallback image
                            />
                        </div>
                    </div>
                </div>
